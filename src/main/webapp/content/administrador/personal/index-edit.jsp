...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/content/administrador/personal/js/index-edit.js"></script>	
]]>
...
<body>
	...
	<s:form autocomplete="off" id="frmPersona" theme="simple"
		...
		<s:hidden name="contrasenaAnterior" value="%{contrasenaAnterior}"/>
		<s:hidden name="correoAnterior" value="%{correoAnterior}"/>
	</s:form>
</body>
	</html>
</jsp:root>